...
def predict(test_sentences, feature_names, f_out):
    for test_sentence in test_sentences:
        ...
        for row in rows:
            # print(row, "\n ", X_test_dict[i], "\n \n")
            # print(X_test_dict[i]['chunk_n1'], "\n", y_pred['chunk_n1'], "\n \n")
            X_test_dict[i]['chunk_n2'] = y_pred['chunk_n2'][0]
            X_test_dict[i]['chunk_n1'] = y_pred['chunk_n1'][0]
...
if __name__ == '__main__':
    ...
    classifier = linear_model.LogisticRegression(penalty='l2', dual=False, solver='newton-cg', max_iter=100, multi_class='auto')
    #solver =’warn’, lbfgs
    #multiclass = 'auto'
