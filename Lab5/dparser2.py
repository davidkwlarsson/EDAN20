...
def get_Xy(file, vec, classifier, column_names, feature_names, idx):
...
if __name__ == '__main__':
    ...
    # file = 'train.conll.txt'
    file = 'test_blind.conll.txt'
    # file = 'test.conll.txt'
    # file = 'mini.conll.txt'
    # file = 'miniB.conll.txt'
    ...
    for i in range(3):
        ...
        get_Xy(file, vec, clf2, column_names_2006_test, feature_names[i], i)
        ...
        # report = metrics.classification_report(y_true, y_pred, labels=None, target_names=None,
                                  #             sample_weight=None, digits=2, output_dict=False)
        # print('f1-score in the penultimate column: \n', report[-160:])
